...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
   ...
   { {1, 1},  756000,  ACPU_SCPLL, 0, 0, 1, 0x0E, L2(7),   975000, 0x03006000},
   ...
   { {1, 1}, 1458000,  ACPU_SCPLL, 0, 0, 1, 0x1B, L2(19), 1137500, 0x03006000},
   ...
   { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(19), 1262500, 0x03006000},

...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
   ...
   { {1, 1},  540000,  ACPU_SCPLL, 0, 0, 1, 0x0A, L2(3),   837500, 0x03006000},
   { {1, 1},  594000,  ACPU_SCPLL, 0, 0, 1, 0x0B, L2(4),   850000, 0x03006000},
   { {1, 1},  648000,  ACPU_SCPLL, 0, 0, 1, 0x0C, L2(5),   862500, 0x03006000},
   ...
   { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(10),  937500, 0x03006000},
   ...
   { {1, 1}, 1242000,  ACPU_SCPLL, 0, 0, 1, 0x17, L2(16), 1037500, 0x03006000},
...
#ifdef CONFIG_CPU_OC
   { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(19), 1187500, 0x03006000},

...
//		int err = p_gesture_ctrl->ctrl_handler.error;		// for compile after not to use CDBG
//		D("%s: error adding control %d", __func__, err);
		D("%s: error adding control %d", __func__, p_gesture_ctrl->ctrl_handler.error);		// for compile after not to use CDBG

...
#ifdef CONFIG_LGE_IRDA
static struct msm_gpiomux_config msm8x60_irda_uart_configs[] __initdata = {
	{
		.gpio		= 62,
		.settings	= {
...
struct msm_gpiomux_configs
msm8x60_lge_325_gpiomux_cfgs[] __initdata = {
#ifdef CONFIG_LGE_PM_CURRENT_CONSUMPTION_FIX
...
#endif
#ifdef CONFIG_LGE_IRDA
	{msm8x60_irda_uart_configs, ARRAY_SIZE(msm8x60_irda_uart_configs)},
#endif
	{msm8x60_aux_pcm_configs, ARRAY_SIZE(msm8x60_aux_pcm_configs)},
	{msm8x60_sdc_configs, ARRAY_SIZE(msm8x60_sdc_configs)},
	{msm8x60_snd_configs, ARRAY_SIZE(msm8x60_snd_configs)},

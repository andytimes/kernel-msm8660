...
static int __init board_revno_setup(char *rev_info)
{
	...
	char *rev_str[] = { "evb1", "evb2", "rev_a", "rev_b", "rev_c", "rev_d",
		...
		"rev_13", "rev_14", "rev_15", "rev_16", "rev_17", "rev_18",
		    "rev_19",
		"revserved"
	};
...
static unsigned short
    atcmd_virtual_keycode[ATCMD_VIRTUAL_KEYPAD_ROW][ATCMD_VIRTUAL_KEYPAD_COL] =
{
	{KEY_1, KEY_8, KEY_UNKNOWN /*KEY_Q */ , KEY_I, KEY_D, KEY_HOME, KEY_B,
	 KEY_UP},
	{KEY_2, KEY_9, KEY_W, KEY_O, KEY_F, KEY_RIGHTSHIFT, KEY_N, KEY_DOWN},
	{KEY_3, KEY_0, KEY_E, KEY_P, KEY_G, KEY_Z, KEY_M, KEY_UNKNOWN},
	{KEY_4, KEY_BACK, KEY_R, KEY_SEARCH, KEY_H, KEY_X, KEY_LEFTSHIFT,
	 KEY_UNKNOWN},
	{KEY_5, KEY_BACKSPACE, KEY_T, KEY_LEFTALT, KEY_J, KEY_C, KEY_REPLY,
	 KEY_CAMERA},
	...
	{KEY_STAR, KEY_SHARP, KEY_END, KEY_UNKNOWN, KEY_UNKNOWN, KEY_UNKNOWN,

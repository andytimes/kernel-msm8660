...
static uint32_t camera_off_gpio_table[] = { GPIO_CFG(GPIO_CAM_MCLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG(GPIO_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), GPIO_CFG(GPIO_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA), GPIO_CFG(GPIO_8M_CAM_RESET_N, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG(GPIO_VT_CAM_RESET_N, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG(GPIO_VT_OSC_EN, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG(GPIO_LED_FLASH_EN, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)	//                                              
    ...
    { GPIO_CFG(GPIO_CAM_MCLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
		GPIO_CFG_2MA), GPIO_CFG(GPIO_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT,
					 GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
GPIO_CFG(GPIO_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA), GPIO_CFG(GPIO_VT_CAM_RESET_N, 0,
						       GPIO_CFG_OUTPUT,
						       GPIO_CFG_NO_PULL,
						       GPIO_CFG_2MA),
...
static int32_t ext_power_ctrl_imx105(int enable) 
{
	    ...
	    camera_off_gpio_table, .camera_off_table_size =
	    ARRAY_SIZE(camera_off_gpio_table), .camera_on_table =
	    camera_on_gpio_table_imx105, .camera_on_table_size =
	    ARRAY_SIZE(camera_on_gpio_table_imx105), .gpio_no_mux = 1, 
};
...
{"8058_lvs0", REG_VS, 1800000, 1800000, -1}, /* +1V8_8MCAM_VIO */ 
	...
	.cam_vreg = msm_cam_vreg_imx105, .num_vreg =
	    ARRAY_SIZE(msm_cam_vreg_imx105), .gpio_conf =
...
static int32_t ext_power_ctrl_mt9m114(int enable) 
{
	    ...
	    camera_off_gpio_table, .camera_off_table_size =
	    ARRAY_SIZE(camera_off_gpio_table), .camera_on_table =
	    camera_on_gpio_table_mt9m114, .camera_on_table_size =
	    ARRAY_SIZE(camera_on_gpio_table_mt9m114), .gpio_no_mux = 1, 
};
...
//                                                                 
    ...
    { .sensor_name = "imx105", 
	    ...
	    &sensor_board_info_imx105, .camera_type = BACK_CAMERA_2D, 
#else	/*  */
	    .sensor_reset = GPIO_8M_CAM_RESET_N, .sensor_pwd = 85, .vcm_pwd =
	    GPIO_8M_CAM_VCM_EN, .vcm_enable = 1, .pdata =
	    &msm_camera_device_data_main_cam, .resource =
	    lge_camera_resources, .num_resources =
	    ARRAY_SIZE(lge_camera_resources), 
#endif	/*  */
	.flash_data = &flash_imx105, .csi_if = 1, .actuator_info =
	    &msm_act_main_cam_3_info, 
};
...
static struct msm_camera_sensor_flash_data flash_mt9m114 = { .flash_type =
    ...
    { .sensor_name = "mt9m114", 
	    ...
	    &sensor_board_info_mt9m114, .camera_type =
	    FRONT_CAMERA_2D, .sensor_type = YUV_SENSOR, 
#else	/*  */
	    .sensor_reset = GPIO_VT_CAM_RESET_N, .sensor_pwd = 85, .vcm_pwd =
	    1, .vcm_enable = 0, .pdata =
	    &msm_camera_device_data_vt_cam, .resource =
	    lge_camera_resources, .num_resources =
	    ARRAY_SIZE(lge_camera_resources), 
#endif	/*  */

...
#if 0 /* moved following macros into devices_ijb_lgu.h */
...
#define MSM_ION_MM_SIZE		0x5C00000 /* (54MB) */
...
static struct touch_platform_data  ijb_lgu_ts_data = {
...
static const unsigned int ijb_lgu_keymap[] = {
...
static struct matrix_keymap_data ijb_lgu_keymap_data = {
	.keymap_size	= ARRAY_SIZE(ijb_lgu_keymap),
	.keymap		= ijb_lgu_keymap,
};

static struct pm8xxx_keypad_platform_data ijb_lgu_keypad_data = {
	.input_name		= "ijb_lgu-keypad",
	.input_phys_device	= "ijb_lgu-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
	...
	.row_hold_ns            = 91500,
	.wakeup			= 1,
	.keymap_data		= &ijb_lgu_keymap_data,
};
...
#ifdef CONFIG_LGE_PMIC8058_KEYPAD
			pm8058_platform_data.keypad_pdata = &ijb_lgu_keypad_data;
#endif

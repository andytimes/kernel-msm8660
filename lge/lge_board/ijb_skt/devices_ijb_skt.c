...
struct msm_rpm_platform_data msm8660_rpm_data __initdata = {
	...
	.ipc_rpm_val = 4,
	.target_id = {
		      MSM_RPM_MAP(8660, NOTIFICATION_CONFIGURED_0, NOTIFICATION,
				  8),
		      MSM_RPM_MAP(8660, NOTIFICATION_REGISTERED_0, NOTIFICATION,
				  8),
		      MSM_RPM_MAP(8660, INVALIDATE_0, INVALIDATE, 8),
		      MSM_RPM_MAP(8660, TRIGGER_TIMED_TO, TRIGGER_TIMED, 1),
		      MSM_RPM_MAP(8660, TRIGGER_TIMED_SCLK_COUNT, TRIGGER_TIMED,
				  1),
		      ...
		      MSM_RPM_MAP(8660, TRIGGER_CLEAR_TRIGGER, TRIGGER_CLEAR,
				  1),
		      ...
		      MSM_RPM_MAP(8660, SYSTEM_FABRIC_CLK, SYSTEM_FABRIC_CLK,
				  1),
		      MSM_RPM_MAP(8660, MM_FABRIC_CLK, MM_FABRIC_CLK, 1),
		      MSM_RPM_MAP(8660, DAYTONA_FABRIC_CLK, DAYTONA_FABRIC_CLK,
				  1),
		      ...
		      MSM_RPM_MAP(8660, APPS_L2_CACHE_CTL, APPS_L2_CACHE_CTL,
				  1),

		      MSM_RPM_MAP(8660, APPS_FABRIC_HALT_0, APPS_FABRIC_HALT,
				  2),
		      MSM_RPM_MAP(8660, APPS_FABRIC_CLOCK_MODE_0,
				  APPS_FABRIC_CLOCK_MODE, 3),
		      MSM_RPM_MAP(8660, APPS_FABRIC_ARB_0, APPS_FABRIC_ARB, 6),

		      MSM_RPM_MAP(8660, SYSTEM_FABRIC_HALT_0,
				  SYSTEM_FABRIC_HALT, 2),
		      MSM_RPM_MAP(8660, SYSTEM_FABRIC_CLOCK_MODE_0,
				  SYSTEM_FABRIC_CLOCK_MODE, 3),
		      MSM_RPM_MAP(8660, SYSTEM_FABRIC_ARB_0, SYSTEM_FABRIC_ARB,
				  22),

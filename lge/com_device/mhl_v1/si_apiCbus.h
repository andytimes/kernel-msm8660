...
//static byte msc_return_value;
    ...
    { MHD_MSC_MSG_NEW_TESTER = 0x80, MHD_MSC_MSG_NEW_TESTER_REPLY =
      0x81,  MHD_MSC_MSG_STATE_CHANGE =
      0x90, MHD_MSC_MSG_STATE_CHANGE_REPLY =
      0x91,  MHD_MSC_MSG_DEVCAP0_CHANGE = 0xA0, MHD_MSC_MSG_DEVCAP1_CHANGE =
      0xA1, MHD_MSC_MSG_DEVCAP2_CHANGE = 0xA2, MHD_MSC_MSG_DEVCAP3_CHANGE =
      0xA3, MHD_MSC_MSG_DEVCAP4_CHANGE = 0xA4, MHD_MSC_MSG_DEVCAP5_CHANGE =
      0xA5, MHD_MSC_MSG_DEVCAP6_CHANGE = 0xA6, MHD_MSC_MSG_DEVCAP7_CHANGE =
      0xA7, MHD_MSC_MSG_DEVCAP8_CHANGE = 0xA8, MHD_MSC_MSG_DEVCAP9_CHANGE =
      0xA9, MHD_MSC_MSG_DEVCAP10_CHANGE = 0xAA, MHD_MSC_MSG_DEVCAP11_CHANGE =
      0xAB, MHD_MSC_MSG_DEVCAP12_CHANGE = 0xAC, MHD_MSC_MSG_DEVCAP13_CHANGE =
      0xAD, MHD_MSC_MSG_DEVCAP14_CHANGE = 0xAE, MHD_MSC_MSG_DEVCAP15_CHANGE =
      0xAF, MHD_MSC_MSG_DEVCAP_CHANGE_REPLY =
      0xB0,  MHD_MSC_MSG_SET_INT0_CHECK = 0xC0, MHD_MSC_MSG_SET_INT1_CHECK =
      0xC1, MHD_MSC_MSG_SET_INT2_CHECK = 0xC2, MHD_MSC_MSG_SET_INT3_CHECK =
      0xC3, MHD_MSC_MSG_SET_INT_REPLY =
      0xC4,  MHD_MSC_MSG_WRITE_STAT0_CHECK =
      0xD0, MHD_MSC_MSG_WRITE_STAT1_CHECK =
      0xD1, MHD_MSC_MSG_WRITE_STAT2_CHECK =
      0xD2, MHD_MSC_MSG_WRITE_STAT3_CHECK =
...
enum  { MHD_MSC_MSG_RAP_NO_ERROR = 0x00,	// RAP No Error
	MHD_MSC_MSG_RAP_UNRECOGNIZED_ACT_CODE =
	    0x01, MHD_MSC_MSG_RAP_UNSUPPORTED_ACT_CODE =

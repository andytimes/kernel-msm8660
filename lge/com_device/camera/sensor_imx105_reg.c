...
//                                                                   
	    ...
	    ARRAY_SIZE(init_tbl),  .prev_tbl =
	    &mode_preview_tbl[0], .prevtbl_size =
	    ARRAY_SIZE(mode_preview_tbl),  .snap_tbl =
	    &mode_snapshot_tbl[0], .snaptbl_size =
	    ARRAY_SIZE(mode_snapshot_tbl),  
//                                                         
	    .prev_1080_tbl = &mode_preview_1080_tbl[0], .prevtbl_1080_size =
	    ARRAY_SIZE(mode_preview_1080_tbl), 
//                                                       
	    
//                                                                     
	    .shutter_tbl = &mode_shutterlag_reg1_tbl[0], .shuttertbl_size =
	    ARRAY_SIZE(mode_shutterlag_reg1_tbl), .shutter2_tbl =
	    &mode_shutterlag_reg2_tbl[0], .shutter2tbl_size =
	    ARRAY_SIZE(mode_shutterlag_reg2_tbl), .shutter2_1080p_tbl =
	    &mode_shutterlag_reg2_1080p_tbl[0], .shutter2_1080ptbl_size =
	    ARRAY_SIZE(mode_shutterlag_reg2_1080p_tbl), 
//                                                                   

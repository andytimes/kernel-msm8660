...
#if CABC
//CABC
static char CABC_ON_Backlight_Control_1[6] =
    { 0xB8, 0x01, 0x1A, 0x18, 0x02, 0x40 };
static char CABC_ON_Backlight_Control_2[8] =
    { 0xB9, 0x18, 0x00, 0x18, 0x18, 0x9F, 0x1F, 0x0F };
...
static struct dsi_cmd_desc hitachi_power_on_set[] = {
	...
	,
	//gamma_setting
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_Start),
	 Manufacture_Command_Access_Start}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(gamma_setting), gamma_setting}
	,
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_End),
	 Manufacture_Command_Access_End}
	,
#if CABC
	//CABC_ON
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_Start),
	 Manufacture_Command_Access_Start}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(CABC_ON_Backlight_Control_1),
	 CABC_ON_Backlight_Control_1}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(CABC_ON_Backlight_Control_2),
	 CABC_ON_Backlight_Control_2}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(CABC_ON_Backlight_Control_3_30),
	 CABC_ON_Backlight_Control_3_30}
	,
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_End),
	 Manufacture_Command_Access_End}
	,
...
//      {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_End),Manufacture_Command_Access_End},
	//set_display_on
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(set_address_mode),
	 set_address_mode}
	,
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(CABC_ON_Backlight_Control_2),
	 CABC_ON_Backlight_Control_2}
	,			//CABC ON
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(CABC_ON_Backlight_Control_3_50),
	 CABC_ON_Backlight_Control_3_50}
	,			//CABC ON
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_End),
	 Manufacture_Command_Access_End}
	,			//CABC ON
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0,
	 sizeof(Panel_Driving_Setting_Colume_inversion),
	 Panel_Driving_Setting_Colume_inversion}
	,			//Column inversion
	{DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(Manufacture_Command_Access_End),
	 Manufacture_Command_Access_End}
	,			//Column inversion
...
#endif
	//enter_sleep_mode
	{DTYPE_DCS_WRITE, 1, 0, 0, 100, sizeof(enter_sleep_mode),
	 enter_sleep_mode}
	,
};
...
#if 0				/*                                         */
	mipi_dsi_cmds_tx(mfd, &hitachi_tx_buf, hitachi_power_on_set,
			 ARRAY_SIZE(hitachi_power_on_set));
#else
	mipi_dsi_cmds_tx(&hitachi_tx_buf, hitachi_power_on_set,
			 ARRAY_SIZE(hitachi_power_on_set));
#endif
...
static int mipi_hitachi_lcd_off(struct platform_device *pdev)
{
	...
	mipi_dsi_cmds_tx(mfd, &hitachi_tx_buf,
			 hitachi_display_off_deep_standby_set,
			 ARRAY_SIZE(hitachi_display_off_deep_standby_set));
#else
	mipi_dsi_cmds_tx(&hitachi_tx_buf, hitachi_display_off_deep_standby_set,
			 ARRAY_SIZE(hitachi_display_off_deep_standby_set));
#endif
...
ssize_t msm_fb_hitachi_show_onoff(struct device *dev,
...
ssize_t msm_fb_hitachi_store_onoff(struct device * dev,
...
DEVICE_ATTR(lcd_refresh, 0644, msm_fb_hitachi_show_onoff,
	    msm_fb_hitachi_store_onoff);

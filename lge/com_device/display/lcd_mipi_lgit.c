...
static char display_ctrl1[8] =
    { 0xB5, 0x01, 0x00, 0x22, 0x00, 0x20, 0x22, 0x00 };
static char display_ctrl2[9] =
    { 0xB6, 0x10, 0x01, 0x81, 0x01, 0x01, 0x00, 0x00, 0x00 };
static char display_ctrl3[8] =
    { 0xB7, 0x46, 0x00, 0x08, 0x00, 0x0C, 0x03, 0x00 };
...
static char p_gamma_r_setting[10] =
    { 0xD0, 0x11, 0x25, 0x76, 0x11, 0x00, 0x00, 0x30, 0x01, 0x02 };
static char n_gamma_r_setting[10] =
    { 0xD1, 0x11, 0x25, 0x76, 0x11, 0x00, 0x00, 0x30, 0x01, 0x02 };
static char p_gamma_g_setting[10] =
    { 0xD2, 0x11, 0x25, 0x76, 0x11, 0x00, 0x00, 0x30, 0x01, 0x02 };
static char n_gamma_g_setting[10] =
    { 0xD3, 0x11, 0x25, 0x76, 0x11, 0x00, 0x00, 0x30, 0x01, 0x02 };
static char p_gamma_b_setting[10] =
    { 0xD4, 0x11, 0x25, 0x76, 0x11, 0x00, 0x00, 0x30, 0x01, 0x02 };
static char n_gamma_b_setting[10] =
    { 0xD5, 0x11, 0x25, 0x76, 0x11, 0x00, 0x00, 0x30, 0x01, 0x02 };
...
static struct dsi_cmd_desc lgit_power_on_set_2P5[] = {
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(column_address_set),
	 column_address_set}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(page_address_set),
	 page_address_set}
	,
...
#if 0				/*                                                       */
	mipi_dsi_cmds_tx(mfd, &lgit_tx_buf, lgit_power_on_set_2P5,

...
static char p_gamma_r_setting[10] =
    { 0xD0, 0x00, 0x30, 0x56, 0x01, 0x12, 0x04, 0x34, 0x10, 0x01 };
static char n_gamma_r_setting[10] =
    { 0xD1, 0x02, 0x51, 0x56, 0x06, 0x08, 0x00, 0x47, 0x12, 0x02 };
static char p_gamma_g_setting[10] =
    { 0xD2, 0x00, 0x30, 0x56, 0x01, 0x12, 0x04, 0x34, 0x10, 0x01 };
static char n_gamma_g_setting[10] =
    { 0xD3, 0x02, 0x51, 0x56, 0x06, 0x08, 0x00, 0x47, 0x12, 0x02 };
static char p_gamma_b_setting[10] =
    { 0xD4, 0x00, 0x30, 0x56, 0x01, 0x12, 0x04, 0x34, 0x10, 0x01 };
static char n_gamma_b_setting[10] =
    { 0xD5, 0x02, 0x51, 0x56, 0x06, 0x08, 0x00, 0x47, 0x12, 0x02 };
#else
//Optimus G calibration
static char p_gamma_r_setting[10] =
    { 0xD0, 0x72, 0x15, 0x76, 0x00, 0x00, 0x00, 0x50, 0x30, 0x02 };
static char n_gamma_r_setting[10] =
    { 0xD1, 0x72, 0x15, 0x76, 0x00, 0x00, 0x00, 0x50, 0x30, 0x02 };
static char p_gamma_g_setting[10] =
    { 0xD2, 0x72, 0x15, 0x76, 0x00, 0x00, 0x00, 0x50, 0x30, 0x02 };
static char n_gamma_g_setting[10] =
    { 0xD3, 0x72, 0x15, 0x76, 0x00, 0x00, 0x00, 0x50, 0x30, 0x02 };
static char p_gamma_b_setting[10] =
    { 0xD4, 0x72, 0x15, 0x76, 0x00, 0x00, 0x00, 0x50, 0x30, 0x02 };
static char n_gamma_b_setting[10] =
    { 0xD5, 0x72, 0x15, 0x76, 0x00, 0x00, 0x00, 0x50, 0x30, 0x02 };
#endif

static char p_gamma_r_setting_2P5[10] =
    { 0xD0, 0x00, 0x11, 0x77, 0x23, 0x16, 0x06, 0x62, 0x41, 0x03 };
static char n_gamma_r_setting_2P5[10] =
    { 0xD1, 0x00, 0x14, 0x63, 0x23, 0x08, 0x06, 0x41, 0x33, 0x04 };
static char p_gamma_g_setting_2P5[10] =
    { 0xD2, 0x00, 0x11, 0x77, 0x23, 0x16, 0x06, 0x62, 0x41, 0x03 };
static char n_gamma_g_setting_2P5[10] =
    { 0xD3, 0x00, 0x14, 0x63, 0x23, 0x08, 0x06, 0x41, 0x33, 0x04 };
static char p_gamma_b_setting_2P5[10] =
    { 0xD4, 0x00, 0x11, 0x77, 0x23, 0x16, 0x06, 0x62, 0x41, 0x03 };
static char n_gamma_b_setting_2P5[10] =
    { 0xD5, 0x00, 0x14, 0x63, 0x23, 0x08, 0x06, 0x41, 0x33, 0x04 };
...
static char power_setting3[10] =
    { 0xC3, 0x00, 0x08, 0x00, 0x00, 0x00, 0x67, 0x88, 0x32, 0x00 };
static char power_setting4[6] = { 0xC4, 0x22, 0x24, 0x19, 0x19, 0x41 };

static char power_setting3_2P5[10] =
    { 0xC3, 0x00, 0x09, 0x10, 0x12, 0x00, 0x66, 0x20, 0x31, 0x00 };
...
static struct dsi_cmd_desc lgit_power_on_set[] = {
	...
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 20, sizeof(power_setting2_1),
	 power_setting2_1}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 20, sizeof(power_setting2_2),
	 power_setting2_2}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 100, sizeof(power_setting2_3),
	 power_setting2_3}
	,
	{DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(exit_sleep), exit_sleep}
	,
...
static struct dsi_cmd_desc lgit_power_on_set_2P5[] = {
	...
	// Gamma Set
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(p_gamma_r_setting_2P5),
	 p_gamma_r_setting_2P5}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(n_gamma_r_setting_2P5),
	 n_gamma_r_setting_2P5}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(p_gamma_g_setting_2P5),
	 p_gamma_g_setting_2P5}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(n_gamma_g_setting_2P5),
	 n_gamma_g_setting_2P5}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(p_gamma_b_setting_2P5),
	 p_gamma_b_setting_2P5}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(n_gamma_b_setting_2P5),
	 n_gamma_b_setting_2P5}
	,
	...
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(power_setting3_2P5),
	 power_setting3_2P5}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(power_setting4_2P5),
	 power_setting4_2P5}
	,
	...
	{DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(power_setting1), power_setting1}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(power_setting2_1),
	 power_setting2_1}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(power_setting2_2),
	 power_setting2_2}
	,
	{DTYPE_GEN_LWRITE, 1, 0, 0, 10, sizeof(power_setting2_3),
	 power_setting2_3}
	,
...
static struct dsi_cmd_desc lgit_display_off_deep_standby_set[] = {
	...
	,
	{DTYPE_DCS_WRITE, 1, 0, 0, 20, sizeof(power_setting4_1),
	 power_setting4_1}
	,
...
extern int mipi_lgit_lcd_ief_off(void)
{
	if (local_mfd0->panel_power_on && is_ief_on) {
		...
		mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_on_set_camera,
				 ARRAY_SIZE(lgit_power_on_set_camera));
		is_ief_on = 0;
		printk("%s, %d\n", __func__, is_ief_on);
...
extern int mipi_lgit_lcd_ief_on(void)
{
	if (local_mfd0->panel_power_on && !is_ief_on) {
		mutex_lock(&local_mfd0->dma->ov_mutex);
		MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x10000000);	//HS mode
		mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_off_set_camera,
				 ARRAY_SIZE(lgit_power_off_set_camera));
		is_ief_on = 1;
		printk("%s, %d\n", __func__, is_ief_on);
		MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x14000000);	//LP mode
		mutex_unlock(&local_mfd0->dma->ov_mutex);
...
void mipi_lgit_lcd_reset(void)
{
	gpio_tlmm_config(GPIO_CFG
			 (LCD_RESET_N, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
...
static int mipi_lgit_lcd_on(struct platform_device *pdev)
{
	...
	if (lge_bd_rev < LGE_REV_C)
		...
		mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_power_on_set_2P5,
				 ARRAY_SIZE(lgit_power_on_set_2P5));
...
static int mipi_lgit_lcd_off(struct platform_device *pdev)
{
	...
	mipi_dsi_cmds_tx(&lgit_tx_buf, lgit_display_off_deep_standby_set,
			 ARRAY_SIZE(lgit_display_off_deep_standby_set));

	gpio_tlmm_config(GPIO_CFG
			 (LCD_RESET_N, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN,
			  GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_set_value(LCD_RESET_N, 0);

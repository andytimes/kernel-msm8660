...
{
	if (vibe_access_status == VIBE_ERROR_1)
		return;
...
//                                                             
		...
		return;
		    ...
		    regulator_set_voltage(snddev_reg_l1, VIBE_IC_VOLTAGE,
					  VIBE_IC_VOLTAGE);
...
}  static void vib_generatePWM(int enable, int amp) 
{
	...
	writel((~(N_VAL - M_VAL) & GPMN_N_MASK),
...
*/ 
    IMMVIBESPIAPI VibeStatus ImmVibeSPI_ForceOut_AmpEnable(VibeUInt8
							   nActuatorIndex) 
{

...
//                                                                                
            ...
            if ( (fd = sys_open((const char __user *) "/data/misc/diag_mac_error", O_RDWR, 0777) ) >= 0 )
            {
                printk(KERN_ERR "[LGF_TestModeWiFiMACRW] write operation is failed!!\n");
				sys_unlink((const char __user *)"/data/misc/diag_mac_error");
				printk(KERN_ERR "[LGF_TestModeWiFiMACRW] writing error noti file is removed!!\n");				
                pRsp->ret_stat_code = TEST_FAIL_S;
                goto file_fail;
            }            
			else{
				printk(KERN_ERR "[LGF_TestModeWiFiMACRW] writing suceess !!!.\n");
			}			
			//--------------------------------------------
//                                                                                
#endif
...
//                                                                                
            ...
            if ( (fd = sys_open((const char __user *) "/data/misc/diag_mac_error", O_RDWR, 0777) ) >= 0 )
            {
                printk(KERN_ERR "[LGF_TestModeWiFiMACRW] read operation is failed!!\n");
                pRsp->ret_stat_code = TEST_FAIL_S;
				sys_unlink((const char __user *)"/data/misc/diag_mac_error");
				printk(KERN_ERR "[LGF_TestModeWiFiMACRW] reading error noti file is removed!!\n");
                goto file_fail;
            }  
			else{
				printk(KERN_ERR "[LGF_TestModeWiFiMACRW] reading suceess !!!.\n");
			}
//                                                                                
#endif

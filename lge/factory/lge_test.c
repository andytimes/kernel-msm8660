...
static int panic_show(struct device *dev, struct device_attribute *attr,
		      char *buf)
{
	int i = 0;
...
static int panic_store(struct device *dev, struct device_attribute *attr,
		       const char *buf, size_t count)
{
	...
	//Watchdog TZ crash
		...
		schedule_delayed_work_on(0, &wdog_test_work_struct,
